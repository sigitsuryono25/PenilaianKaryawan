    ...
    <div class="container">
        <div class="table-reponsive">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="aktiva-tab" data-toggle="tab" href="#aktiva" role="tab" aria-controls="aktiva" aria-selected="true">PEMASUKKAN</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pasiva-tab" data-toggle="tab" href="#pasiva" role="tab" aria-controls="pasiva" aria-selected="false">PENGELUARAN</a>
                </li>
            </ul>
                ...
                <div class="table-responsive">
                        <table class="table table-sm table-bordered" id="tables-pasiva">
                            ...
                            <tfoot style="background-color: cornflowerblue;color: white;">
                                <tr>
                                    <td colspan="2">TOTAL PEMASUKKAN</td>
            ...
            <h6 class="mt-4 text-center p-2" style="background-color: navy;color: white;">LABA / RUGI <br>Rp. <?= $this->etc->rps(str_replace(",", "", $jumlah_kanan) - str_replace(",", "", $jumlah_kiri)); ?></h6>
        </div>
    </div>

	...
	<div class="card-body">
		<form id="frmUser">
			<div class="form-group">
				...
				<input type="text" value="<?= $user->userid ?>" readonly name="userid" id="userid" class="form-control" required>
			</div>
			<div class="form-group">
				<label for="password">Password</label>
				<input type="password" name="password" id="password" class="form-control">
				<small class="text-danger font-weight-bold">Kosongkan jika tidak ingin mengganti password</small>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<select name="jabatan" id="jabatan" class="form-control" required>
					...
					<?php foreach ($jabatan as $j) { ?>
						<option value="<?= $j->id_jabatan ?>" <?= ($j->id_jabatan == $user->jabatan) ? "selected" : "" ?>><?= $j->nama_jabatan ?></option>
					<?php } ?>
				</select>
			</div>
			<div class="form-group">
...
<script>
	var url = "<?= site_url('user/action-update') ?>";
